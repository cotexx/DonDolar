...
import { ArrowLeft, TrendingUp, ArrowRight, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function Economy() {
  ...
  return (
    <div id="economy-page" className={`min-h-screen ${darkMode ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900' : 'bg-gradient-to-br from-blue-900 via-blue-700 to-blue-800'}`}>
      <Navbar darkMode={darkMode} onDarkModeToggle={() => setDarkMode(!darkMode)} />
      <div className="container mx-auto px-4 py-12">
        <Header />
        ...
        <div id="page-header" className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h2 className="text-4xl font-bold text-white">Economía y Finanzas</h2>
